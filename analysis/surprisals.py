...
saycam_file_paths = [
    "old_results/vjepa_say_base_no_rope/intuitive_physics/inflevel_lab-default/losses_continuity_5fs_4_8_12_16_20ctxt.pth",
    "old_results/vjepa_say_base_no_rope/intuitive_physics/inflevel_lab-default/losses_gravity_5fs_4_8_12_16_20ctxt.pth",
    "old_results/vjepa_say_base_no_rope/intuitive_physics/inflevel_lab-default/losses_solidity_5fs_4_8_12_16_20ctxt.pth",
]

meta_file_paths = [
    "old_results/vit-l-rope-howto-0/inflevel/raw_surprises/continuity_32frames.pth",
    "old_results/vit-l-rope-howto-0/inflevel/raw_surprises/gravity_32frames.pth",
    "old_results/vit-l-rope-howto-0/inflevel/raw_surprises/solidity_32frames.pth",
]
...
def load_metrics_data(file_path):
    if not os.path.exists(file_path):
        print(
            f"ERROR: File not found at {file_path} (CWD: {os.getcwd()})"
        )  # Added CWD for context
        return None
    try:
...
def main():
    ...
    for saycam_file, meta_file_path in zip(saycam_file_paths, meta_file_paths):
        ...
        say_losses_for_plot = (
            say_losses_for_plot / norm_say if norm_say != 0 else say_losses_for_plot
        )
        ...
        meta_losses_for_plot = (
            meta_losses_for_plot / norm_meta if norm_meta != 0 else meta_losses_for_plot
        )
        ...
        if frame_numbers is None:
            ...
            if (
                num_frames_from_losses == 1
                and say_losses_for_plot.ndim == 1
                and len(say_losses_for_plot) == 1
            ):
        ...
        plt.plot(
            frame_numbers, say_losses_for_plot, marker=".", linestyle="-", color="blue"
        )
        plt.plot(
            frame_numbers,
            meta_losses_for_plot,
        ...
        plt.tight_layout()
        save_path = f"~/vjepa/plots/{labels[i]}_surprisals.png"
